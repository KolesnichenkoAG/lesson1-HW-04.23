...
import gb.ru.lesson5.repository.StudentRepositoryDao;
import gb.ru.lesson5.services.StudentService;
import gb.ru.lesson5.utils.HibernateUtil;
...
public class Tests {
    ...
    public Tests() {
        ...
        StudentRepository studentRepository = new StudentRepositoryDao(factory);
